...
class BME280:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.error("TCE: BME280 Init Error ->" + str(e))
    ...
    def getData(self):
        ...
        if self.isAvailable:
            ...
            main_data["temp"] = self.compensate_T(temp_raw)
            main_data["pres"] = self.compensate_P(pres_raw)
            main_data["hum"] = self.compensate_H(hum_raw)
...
if __name__ == '__main__':
    ...
    x = bme280.getData()
    if x["status"] == True:
        print("pressure :",x["pres"],"hPa")
        print("temp :",x["temp"],"℃")
        print("hum :",x["hum"],"％")
    else:
        print("BME280 No Data")
